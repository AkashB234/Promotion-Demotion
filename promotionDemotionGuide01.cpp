...
void breadthFirstSearch(vector<list<int>> adjacencyList, int parent[], int level[], int start)
{
    ...
    while (!queue.empty()) // While there are vertices to be processed
    {
        ...
        {
            if (level[*itr] == -1)
            {                                       // Check if it is an unvisited vertex
...
int main()
{
    ...
    printf("WELCOME TO PROMOTION-DEMOTION GUIDE -\n");

    printf("Level-1 : (1-10) tarinee_new employee joining to company -\n");
    printf("Level-2 : (11-20) engineer -\n");
    printf("Level-3 : (21-30) team lead -\n");
    printf("Level-4 : (31-40) junior manager -\n");
    printf("Level-5 : (41-50) senior manager -\n");
    printf("Level-6 : (51-60) manager -\n");
    printf("Level-7 : (61-70) officer D -\n");
    printf("Level-8 : (71-80) officer C -\n");
    printf("Level-9 : (81-90) officer B -\n");
    printf("Level-10 : (91-100) CEO of the Comapany -\n");
    printf("Only LEVEL TO LEVEL Promotion and Demotion are allowed -\n");

    printf("Enter number of Promotions -\n");
    scanf("%d", &numOfLadders);
    printf("Enter the Promotion Threshold V1 which goes from V1 -> V2\n");
    ...
    printf("Enter number of Demotions Threshold -\n");
    scanf("%d", &numOfSnakes);
    printf("Enter the Demotion Threshold V1 which goes from V1 -> V2\n");
    ...
    printf("Only OPTIMAL work can get a promotion -\n");
    printf("Too hard and Too lazy work might miss a promotion -\n");
    printf("So we need a planner to decide --> how much exact work we should put, at every stage of career, acc to entered promotion and demotion threashold at every stage -\n");

    printf("\nThe Career Path Should Be-\n");

    // Printing Adjacency List
    for (int i = 1; i < adjacencyList.size(); ++i)
    {
        printf("Career_Path[%d] ", i);
    ...
    printf("\nThe Optimal Moves Required To Reach The CEO Position = %d\n", level[100]);

    // Print path from Vertex 1 to Vertex 100
    printf("The Optimal Career Path Required To Reach The CEO Position = ");
